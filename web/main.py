...
def assess(contractor_id: str) -> dict:
    return assess_contractor_readiness_with_audit(
        contractor_id
    )
...
def explain(contractor_id: str) -> dict:
    return explain_contractor_readiness(
        contractor_id
    )
...
def compare(contractor_id: str) -> dict:
    return compare_contractor_assessments(
        contractor_id
    )
...
def propose(contractor_id: str) -> dict:
    return propose_followup_actions(
        contractor_id
    )
...
def taskmaster(contractor_id: str) -> dict:
    return run_taskmaster_workflow(
        contractor_id
    )
